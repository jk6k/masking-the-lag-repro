...
def render_fig2(input_csv: Path, out_dir: Path, review_dir: Path, run_tag: str):
    ...
    trace_row = {
        ...
        "literature_style_anchors": "paper_bibliography:ASTRA_Stochastic_Transformer_Silicon_Photonics_TECS2025::Fig3-Fig5 | paper_bibliography:Lightening_Transformer_HPCA2024::Fig5 | paper_bibliography:HyAtten_Hybrid_Photonic_Digital_Attention_Accelerator::Fig3-Fig4 | paper_bibliography:TeMPO_Transformer_Acceleration_with_Co-packaged_Silicon_Photonics::Fig3-Fig5",
