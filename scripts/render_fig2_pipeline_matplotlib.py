...
def render_fig2(input_csv: Path, out_dir: Path, review_dir: Path, run_tag: str):
    ...
    trace_row = {
        ...
        "literature_style_anchors": "public_redacted_provenancemarkdown/01_transformer_attention_photonic/ASTRA_Stochastic_Transformer_Silicon_Photonics_TECS2025.md::Fig3-Fig5 | public_redacted_provenancemarkdown/01_transformer_attention_photonic/Lightening_Transformer_HPCA2024.md::Fig5 | public_redacted_provenancemarkdown/01_transformer_attention_photonic/2501.11286_HyAtten_Hybrid_Photonic_Digital_Attention_Accelerator.md::Fig3-Fig4 | public_redacted_provenancemarkdown/01_transformer_attention_photonic/2402.07393_TeMPO_Transformer_Acceleration_with_Co-packaged_Silicon_Photonics.md::Fig3-Fig5",
        ...
        "source_pack_run_tag": "public_redacted_path",
