...
Promotion decision: `pivot_scaffolded_not_submission_ready`
...
- Required partials: `G1`
- Highest-priority next step: Draft and red-team the full architecture-first TETC manuscript source without weakening the protected fallback.
...
| G1 Full TETC manuscript source | `True` | `partial` | fallback_title=The Missing Interface: Timing Slack as a Quality-Budget Signal for Photonic/DPTC Resource Control; tetc_source=paper/suds_tetc_architecture_manuscript.tex; tetc_title=Scheduler-Derived Budget Interfaces for Dynamic Photonic Transformer Accelerators | `` | Promote the architecture-first TETC source only after G2-G5 pass and red-team review. |
...
circuit signoff. The protected methodology manuscript remains the
fallback until the architecture-first TETC manuscript source, figures, public
repro package, and red-team checks agree with the same claim boundaries.
