...
|---|---:|---:|---:|---:|---|---|
| `bert_base_seq64_batch1_r9` | 64 | 1 | 29.26% | 33.47% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq64_batch4_r9` | 64 | 4 | 29.19% | 33.41% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq64_batch8_r9` | 64 | 8 | 29.13% | 33.35% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq128_batch1_r9` | 128 | 1 | 29.23% | 33.44% | `existing_mps_anchor` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq128_batch4_r9` | 128 | 4 | 29.13% | 33.34% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq128_batch8_r9` | 128 | 8 | 29.07% | 33.28% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq256_batch1_r9` | 256 | 1 | 29.18% | 33.38% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq256_batch4_r9` | 256 | 4 | 29.05% | 33.27% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq256_batch8_r9` | 256 | 8 | 29.01% | 33.22% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq512_batch1_r9` | 512 | 1 | 29.10% | 33.30% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq512_batch4_r9` | 512 | 4 | 29.00% | 33.21% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
| `bert_base_seq512_batch8_r9` | 512 | 8 | 28.97% | 33.18% | `not_run_boundary_or_blocker_recorded` | `architecture_support_with_accuracy_boundary` |
