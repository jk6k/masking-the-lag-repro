...
|---|---|---|---|---|---|---|
| `R11-EXT0` | `external_independence` | `medium` | `abandoned` | External independent reviewer review is permanently abandoned for this project. | The R11 red-team is fully self-contained through internal evidence artifacts; no external reviewer will be contacted. | Do not reference external review as pending, preferred, or planned in the manuscript or reports. |
